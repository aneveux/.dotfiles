...
<!-- For checkpoint task examples and patterns, see @/home/antoine/.claude/get-shit-done/references/checkpoints.md -->
...
See `/home/antoine/.claude/get-shit-done/references/tdd.md` for TDD plan structure.
...
See `/home/antoine/.claude/get-shit-done/templates/user-setup.md` for full schema and examples
...
See `/home/antoine/.claude/get-shit-done/workflows/verify-phase.md` for verification logic.
