...
- Meaningful variable names over comments; no comments that restate what the code does
...
- Git repo like `cloudbees/xxx` or `jenkinsci/xxx` → check `~/projects` for an existing checkout first, else `gh repo clone`
